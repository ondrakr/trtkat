      ...
      <div className="w-full min-w-0">
        <div className="quiz-score-enter relative overflow-hidden glass-card rounded-3xl md:rounded-[2.5rem] bg-gradient-to-br from-trtkat-blue/10 via-transparent to-trtkat-pink/10 p-8 sm:p-10 md:p-12 text-center shadow-2xl">
          ...
          <button
            type="button"
            onClick={reset}
            className="relative inline-flex items-center gap-2 rounded-2xl glass-subtle glass-interactive px-6 py-3 text-sm font-black text-white"
          >
              ...
              <button
                ...
                className={cn(
                  ...
                  index === 0
                    ...
                    : 'text-slate-300 hover:text-white glass-subtle sm:border-transparent',
                )}
              >
